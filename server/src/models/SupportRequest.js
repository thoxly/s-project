...
const supportRequestSchema = new mongoose.Schema({
  ...
  currentStatus: {
    type: String,
    default: 'Новая',
    // Разрешаем любой статус, так как ELMA может отправлять разные статусы
    // Предустановленные статусы для фронтенда: 'Новая', 'В работе', 'На уточнении', 'Закрыта', 'Отложена', 'Отменена', 'Выполнена', 'Принята'
    index: true
  },
